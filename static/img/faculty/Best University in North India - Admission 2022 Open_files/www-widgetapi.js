...
function wk(a,b,c){a=a.i.openCursor(b.query,b.direction);return yk(a).then(function(d){return lk(d,c)})}
...
function zk(a,b,c){a=a.i.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return yk(a).then(function(d){return lk(d,c)})}
...
Fk.prototype.open=function(){function a(){var f,g,h,k,l,n,q,w,p,y;return x(function(z){switch(z.i){case 1:return g=null!=(f=Error().stack)?f:"",xa(z,2),v(z,c.l(c.name,c.options.version,e),4);case 4:h=z.j;for(var F=c.options,K=[],M=t(Object.keys(F.ha)),O=M.next();!O.done;O=M.next()){O=O.value;var fb=F.ha[O],ic=void 0===fb.sb?Number.MAX_VALUE:fb.sb;!(h.i.version>=fb.ya)||h.i.version>=ic||h.i.objectStoreNames.contains(O)||K.push(O)}k=K;if(0===k.length){z.s(5);break}l=Object.keys(c.options.ha);n=h.objectStoreNames();
if(c.A<Vh("ytidb_reopen_db_retries",0))return c.A++,h.close(),Xi(new T("DB_REOPENED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:l,foundObjectStores:n})),z.return(a());if(!(c.o<Vh("ytidb_remake_db_retries",1))){z.s(6);break}c.o++;if(!P("ytidb_remake_db_enable_backoff_delay")){z.s(7);break}return v(z,Ek(c.j),8);case 8:c.j*=2;case 7:return v(z,c.delete(),9);case 9:return Xi(new T("DB_DELETED_BY_MISSING_OBJECT_STORES",{dbName:c.name,expectedObjectStores:l,foundObjectStores:n})),z.return(a());
case 6:throw new jj(n,l);case 5:return z.return(h);case 2:q=za(z);if(q instanceof DOMException?"VersionError"!==q.name:"DOMError"in self&&q instanceof DOMError?"VersionError"!==q.name:!(q instanceof Object&&"message"in q)||"An attempt was made to open a database using a lower version than the existing version."!==q.message){z.s(10);break}return v(z,c.l(c.name,void 0,Object.assign({},e,{upgrade:void 0})),11);case 11:w=z.j;p=w.i.version;if(void 0!==c.options.version&&p>c.options.version+1)throw w.close(),
c.m=!1,Gk(c,p);return z.return(w);case 10:throw b(),q instanceof Error&&!P("ytidb_async_stack_killswitch")&&(q.stack=q.stack+"\n"+g.substring(g.indexOf("\n")+1)),mj(q,c.name,"",null!=(y=c.options.version)?y:-1);}})}
function b(){c.i===d&&(c.i=void 0)}
var c=this;if(!this.m)throw Gk(this);if(this.i)return this.i;var d,e={blocking:function(f){f.close()},
closed:b,ub:b,upgrade:this.options.upgrade};return this.i=d=a()};var Ik=new Fk("YtIdbMeta",{ha:{databases:{ya:1}},upgrade:function(a,b){b(1)&&ok(a,"databases",{keyPath:"actualName"})}});
function Jk(a,b){var c;return x(function(d){if(1==d.i)return v(d,Hk(Ik,b),2);c=d.j;return d.return(nk(c,["databases"],{I:!0,mode:"readwrite"},function(e){var f=e.objectStore("databases");return f.get(a.actualName).then(function(g){if(g?a.actualName!==g.actualName||a.publicName!==g.publicName||a.userIdentifier!==g.userIdentifier:1)return V(f.i.put(a,void 0)).then(function(){})})}))})}
function Kk(a,b){var c;return x(function(d){if(1==d.i)return a?v(d,Hk(Ik,b),2):d.return();c=d.j;return d.return(c.delete("databases",a))})}
function Lk(a,b){var c,d;return x(function(e){return 1==e.i?(c=[],v(e,Hk(Ik,b),2)):3!=e.i?(d=e.j,v(e,nk(d,["databases"],{I:!0,mode:"readonly"},function(f){c.length=0;return wk(f.objectStore("databases"),{},function(g){a(g.X())&&c.push(g.X());return g.continue()})}),3)):e.return(c)})}
...
function Qk(){if(void 0!==Nk)return Nk;Wi=!0;return Nk=Pk().then(function(a){Wi=!1;var b;if(null!=(b=Ti())&&b.i){var c;b={hasSucceededOnce:(null==(c=Ui())?void 0:c.hasSucceededOnce)||a};var d;null==(d=Ti())||d.set("LAST_RESULT_ENTRY_KEY",b,2592E3,!0)}return a})}
...
function Uk(a,b,c,d){var e,f,g,h,k,l;return x(function(n){switch(n.i){case 1:return f=null!=(e=Error().stack)?e:"",v(n,Sk(),2);case 2:g=n.j;if(!g)throw h=nj("openDbImpl",a,b),P("ytidb_async_stack_killswitch")||(h.stack=h.stack+"\n"+f.substring(f.indexOf("\n")+1)),Xi(h),h;bj(a);k=c?{actualName:a,publicName:a,userIdentifier:void 0}:Tk(a);xa(n,3);return v(n,Jk(k,g),5);case 5:return v(n,Ck(k.actualName,b,d),6);case 6:return n.return(n.j);case 3:return l=za(n),xa(n,7),v(n,Kk(k.actualName,g),9);case 9:ya(n,
...
function Xk(a,b){b=void 0===b?{}:b;var c,d;return x(function(e){if(1==e.i)return v(e,Sk(),2);if(3!=e.i){c=e.j;if(!c)return e.return();bj(a);d=Tk(a);return v(e,Dk(d.actualName,b),3)}return v(e,Kk(d.actualName,c),0)})}
function Yk(a,b,c){a=a.map(function(d){return x(function(e){return 1==e.i?v(e,Dk(d.actualName,b),2):v(e,Kk(d.actualName,c),0)})});
return Promise.all(a).then(function(){})}
function Zk(){var a=void 0===a?{}:a;var b,c;return x(function(d){if(1==d.i)return v(d,Sk(),2);if(3!=d.i){b=d.j;if(!b)return d.return();bj("LogsDatabaseV2");return v(d,Mk(b),3)}c=d.j;return v(d,Yk(c,a,b),0)})}
function $k(a,b){b=void 0===b?{}:b;var c;return x(function(d){if(1==d.i)return v(d,Sk(),2);if(3!=d.i){c=d.j;if(!c)return d.return();bj(a);return v(d,Dk(a,b),3)}return v(d,Kk(a,c),0)})}
;function al(a){this.i=!1;this.potentialEsfErrorCounter=this.j=0;this.handleError=function(){};
this.ca=function(){};
...
(!this.B||this.B("networkless_logging"))&&bl(this)}
function bl(a){a.u&&!a.fa&&(a.i=!0,a.qa&&Math.random()<=a.pa&&a.F.ib(a.u),cl(a),a.H.G()&&a.ka(),a.H.S(a.Fa,a.ka.bind(a)),a.H.S(a.Ea,a.Ja.bind(a)))}
m=al.prototype;m.writeThenSend=function(a,b){var c=this;b=void 0===b?{}:b;if(this.u&&this.i){var d={url:a,options:b,timestamp:this.now(),status:"NEW",sendCount:0};this.F.set(d,this.u).then(function(e){d.id=e;c.H.G()&&dl(c,d)}).catch(function(e){dl(c,d);
el(c,e)})}else this.U(a,b)};
...
b.onError=function(g,h){return x(function(k){if(1==k.i)return v(k,d.F.set(e,d.u).catch(function(l){el(d,l)}),2);
f(g,h);k.i=0})}}this.U(a,b,e.skipRetry)}else this.F.set(e,this.u).catch(function(g){d.U(a,b,e.skipRetry);
el(d,g)})}else this.U(a,b,this.B&&this.B("nwl_skip_retry")&&c)};
...
this.U(d.url,d.options);this.F.set(d,this.u).then(function(g){d.id=g;e&&c.F.ba(d.id,c.u)}).catch(function(g){el(c,g)})}else this.U(a,b)};
m.ka=function(){var a=this;if(!this.u)throw nj("throttleSend");this.j||(this.j=this.K.M(function(){var b;return x(function(c){if(1==c.i)return v(c,a.F.Oa("NEW",a.u),2);if(3!=c.i)return b=c.j,b?v(c,dl(a,b),3):(a.Ja(),c.return());a.j&&(a.j=0,a.ka());c.i=0})},this.ab))};
m.Ja=function(){this.K.Z(this.j);this.j=0};
function dl(a,b){var c,d;return x(function(e){switch(e.i){case 1:if(!a.u)throw c=nj("immediateSend"),c;if(void 0===b.id){e.s(2);break}return v(e,a.F.qb(b.id,a.u),3);case 3:(d=e.j)?b=d:a.ca(Error("The request cannot be found in the database."));case 2:if(fl(a,b,a.Xa)){e.s(4);break}a.ca(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===b.id){e.s(5);break}return v(e,a.F.ba(b.id,a.u),5);case 5:return e.return();case 4:b.skipRetry||(b=gl(a,b));if(!b){e.s(0);break}if(!b.skipRetry||
void 0===b.id){e.s(8);break}return v(e,a.F.ba(b.id,a.u),8);case 8:a.U(b.url,b.options,!!b.skipRetry),e.i=0}})}
function gl(a,b){if(!a.u)throw nj("updateRequestHandlers");var c=b.options.onError?b.options.onError:function(){};
b.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:g=hl(f);if(!(a.B&&a.B("nwl_consider_error_code")&&g||a.B&&!a.B("nwl_consider_error_code")&&a.potentialEsfErrorCounter<=a.va)){l.s(2);break}if(!a.H.V){l.s(3);break}return v(l,a.H.V(),3);case 3:if(a.H.G()){l.s(2);break}c(e,f);if(!a.B||!a.B("nwl_consider_error_code")||void 0===(null==(h=b)?void 0:h.id)){l.s(6);break}return v(l,a.F.Ga(b.id,a.u,!1),6);case 6:return l.return();case 2:if(a.B&&a.B("nwl_consider_error_code")&&
...
function cl(a){if(!a.u)throw nj("retryQueuedRequests");a.F.Oa("QUEUED",a.u).then(function(b){b&&!fl(a,b,a.Wa)?a.K.M(function(){return x(function(c){if(1==c.i)return void 0===b.id?c.s(2):v(c,a.F.Ga(b.id,a.u),2);cl(a);c.i=0})}):a.H.G()&&a.ka()})}
function el(a,b){a.bb&&!a.H.G()?a.bb(b):a.handleError(b)}
function hl(a){var b;return(a=null==a?void 0:null==(b=a.error)?void 0:b.code)&&400<=a&&599>=a?!1:!0}
;var il=B("ytPubsub2Pubsub2Instance")||new L;L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.la;L.prototype.publish=L.prototype.da;L.prototype.clear=L.prototype.clear;C("ytPubsub2Pubsub2Instance",il);C("ytPubsub2Pubsub2SubscribedKeys",B("ytPubsub2Pubsub2SubscribedKeys")||{});C("ytPubsub2Pubsub2TopicToKeys",B("ytPubsub2Pubsub2TopicToKeys")||{});C("ytPubsub2Pubsub2IsAsync",B("ytPubsub2Pubsub2IsAsync")||{});C("ytPubsub2Pubsub2SkipSubKey",null);function jl(a,b){Fk.call(this,a,b);this.options=b;bj(a)}
u(jl,Fk);function kl(a,b){var c;return function(){c||(c=new jl(a,b));return c}}
jl.prototype.l=function(a,b,c){c=void 0===c?{}:c;return(this.options.Ha?Wk:Vk)(a,b,Object.assign({},c))};
jl.prototype.delete=function(a){a=void 0===a?{}:a;return(this.options.Ha?$k:Xk)(this.name,a)};
function ll(a,b){return kl(a,b)}
;var ml;
function nl(){if(ml)return ml();var a={};ml=ll("LogsDatabaseV2",{ha:(a.LogsRequestsStore={ya:2},a),Ha:!1,upgrade:function(b,c,d){c(2)&&ok(b,"LogsRequestsStore",{keyPath:"id",autoIncrement:!0});c(3);c(5)&&(d=d.objectStore("LogsRequestsStore"),d.i.indexNames.contains("newRequest")&&d.i.deleteIndex("newRequest"),d.i.createIndex("newRequestV2",["status","interface","timestamp"],{unique:!1}));c(7)&&b.i.objectStoreNames.contains("sapisid")&&b.i.deleteObjectStore("sapisid");c(9)&&b.i.objectStoreNames.contains("SWHealthLog")&&b.i.deleteObjectStore("SWHealthLog")},
version:9});return ml()}
;function ol(a){return Hk(nl(),a)}
function pl(a,b){var c,d,e,f;return x(function(g){if(1==g.i)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_WRITE"},v(g,ol(b),2);if(3!=g.i)return d=g.j,e=Object.assign({},a,{options:JSON.parse(JSON.stringify(a.options)),interface:N("INNERTUBE_CONTEXT_CLIENT_NAME",0)}),v(g,qk(d,e),3);f=g.j;c.vb=R();ql(c);return g.return(f)})}
function rl(a,b){var c,d,e,f,g,h,k;return x(function(l){if(1==l.i)return c={startTime:R(),transactionType:"YT_IDB_TRANSACTION_TYPE_READ"},v(l,ol(b),2);if(3!=l.i)return d=l.j,e=N("INNERTUBE_CONTEXT_CLIENT_NAME",0),f=[a,e,0],g=[a,e,R()],h=IDBKeyRange.bound(f,g),k=void 0,v(l,nk(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(n){return zk(n.objectStore("LogsRequestsStore").index("newRequestV2"),{query:h,direction:"prev"},function(q){q.X()&&(k=q.X(),"NEW"===a&&(k.status="QUEUED",q.update(k)))})}),
3);
c.vb=R();ql(c);return l.return(k)})}
function sl(a,b){var c;return x(function(d){if(1==d.i)return v(d,ol(b),2);c=d.j;return d.return(nk(c,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(e){var f=e.objectStore("LogsRequestsStore");return f.get(a).then(function(g){if(g)return g.status="QUEUED",V(f.i.put(g,void 0)).then(function(){return g})})}))})}
function tl(a,b,c){c=void 0===c?!0:c;var d;return x(function(e){if(1==e.i)return v(e,ol(b),2);d=e.j;return e.return(nk(d,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(f){var g=f.objectStore("LogsRequestsStore");return g.get(a).then(function(h){return h?(h.status="NEW",c&&(h.sendCount+=1),V(g.i.put(h,void 0)).then(function(){return h})):U.resolve(void 0)})}))})}
function ul(a,b){var c;return x(function(d){if(1==d.i)return v(d,ol(b),2);c=d.j;return d.return(c.delete("LogsRequestsStore",a))})}
function vl(a){var b,c;return x(function(d){if(1==d.i)return v(d,ol(a),2);b=d.j;c=R()-2592E6;return v(d,nk(b,["LogsRequestsStore"],{mode:"readwrite",I:!0},function(e){return wk(e.objectStore("LogsRequestsStore"),{},function(f){if(f.X().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
...
;var xl={},yl=ll("ServiceWorkerLogsDatabase",{ha:(xl.SWHealthLog={ya:1},xl),Ha:!0,upgrade:function(a,b){b(1)&&ok(a,"SWHealthLog",{keyPath:"id",autoIncrement:!0}).i.createIndex("swHealthNewRequest",["interface","timestamp"],{unique:!1})},
version:1});function zl(a){return Hk(yl(),a)}
function Al(a){var b,c;x(function(d){if(1==d.i)return v(d,zl(a),2);b=d.j;c=R()-2592E6;return v(d,nk(b,["SWHealthLog"],{mode:"readwrite",I:!0},function(e){return wk(e.objectStore("SWHealthLog"),{},function(f){if(f.X().timestamp<=c)return f.delete().then(function(){return f.continue()})})}),0)})}
function Bl(a){var b;return x(function(c){if(1==c.i)return v(c,zl(a),2);b=c.j;return v(c,b.clear("SWHealthLog"),0)})}
;var Cl={},Dl=0;
function El(a){var b=void 0===b?"":b;var c=void 0===c?!1:c;if(a)if(b)ii(a,void 0,"POST",b);else if(N("USE_NET_AJAX_FOR_PING_TRANSPORT",!1))ii(a,void 0,"GET","",void 0,void 0,c);else{b:{try{var d=new $a({url:a});if(d.l&&d.j||d.m){var e=Sb(a.match(Rb)[5]||null);var f=!(!e||!e.endsWith("/aclk")||"1"!==Yb(a,"ri"));break b}}catch(h){}f=!1}if(f){b:{try{if(window.navigator&&window.navigator.sendBeacon&&window.navigator.sendBeacon(a,"")){var g=!0;break b}}catch(h){}g=!1}b=g?!0:!1}else b=!1;b||Fl(a)}}
function Fl(a){var b=new Image,c=""+Dl++;Cl[c]=b;b.onload=b.onerror=function(){delete Cl[c]};
b.src=a}
;function W(){this.i=new Map;this.j=!1}
function Gl(){if(!W.i){var a=B("yt.networkRequestMonitor.instance")||new W;C("yt.networkRequestMonitor.instance",a);W.i=a}return W.i}
...
;var Ll=Vh("network_polling_interval",3E4);function Z(){J.call(this);var a=this;this.ma=0;this.C=this.o=!1;this.j=this.za();P("use_shared_nsm")?(this.i=Ce(),P("use_shared_nsm_and_keep_yt_online_updated")&&(this.i.S("networkstatus-online",function(){a.j=!0;a.C&&Kl()}),this.i.S("networkstatus-offline",function(){a.j=!1}))):(Ml(this),Nl(this))}
u(Z,J);function Ol(){if(!Z.i){var a=B("yt.networkStatusManager.instance")||new Z;C("yt.networkStatusManager.instance",a);Z.i=a}return Z.i}
...
m.rb=function(a){!P("use_shared_nsm")&&(this.o=!0,void 0===a?0:a)&&(this.ma||Pl(this))};
...
function Nl(a){window.addEventListener("online",function(){return x(function(b){if(1==b.i)return v(b,a.V(),2);a.C&&Kl();b.i=0})})}
function Ml(a){window.addEventListener("offline",function(){return x(function(b){return v(b,a.V(),0)})})}
function Pl(a){a.ma=Ni(function(){return x(function(b){if(1==b.i)return a.j?a.za()||!a.o?b.s(3):v(b,a.V(),3):v(b,a.V(),3);Pl(a);b.i=0})},Ll)}
m.V=function(a){var b=this;if(P("use_shared_nsm")&&this.i){var c=Ae(this.i,a);c.then(function(d){P("use_cfr_monitor")&&Gl().requestComplete("generate_204",d)});
...
signal:g}),5);case 5:h=!0;case 3:Aa(k);P("use_cfr_monitor")&&Gl().requestComplete("generate_204",h);b.v=void 0;b.P&&De.Z(b.P);h!==b.j&&(b.j=h,b.j&&b.o?xe(b,"ytnetworkstatus-online"):b.o&&xe(b,"ytnetworkstatus-offline"));d(h);Ba(k);break;case 2:za(k),h=!1,k.s(3)}})})};
Z.prototype.sendNetworkCheckRequest=Z.prototype.V;Z.prototype.listen=Z.prototype.S;Z.prototype.enableErrorFlushing=Z.prototype.kb;Z.prototype.getWindowStatus=Z.prototype.za;Z.prototype.monitorNetworkStatusChange=Z.prototype.rb;Z.prototype.networkStatusHint=Z.prototype.T;Z.prototype.isNetworkAvailable=Z.prototype.G;Z.getInstance=Ol;function Ql(a){a=void 0===a?{}:a;J.call(this);var b=this;this.j=this.P=0;this.o="ytnetworkstatus-offline";this.v="ytnetworkstatus-online";P("use_shared_nsm")&&(this.o="networkstatus-offline",this.v="networkstatus-online");this.i=Ol();var c=B("yt.networkStatusManager.instance.monitorNetworkStatusChange").bind(this.i);c&&c(a.Ma);a.Ta&&(c=B("yt.networkStatusManager.instance.enableErrorFlushing").bind(this.i))&&c();if(c=B("yt.networkStatusManager.instance.listen").bind(this.i))a.wa?(this.wa=a.wa,c(this.v,
function(){Rl(b,"publicytnetworkstatus-online")}),c(this.o,function(){Rl(b,"publicytnetworkstatus-offline")})):(c(this.v,function(){xe(b,"publicytnetworkstatus-online")}),c(this.o,function(){xe(b,"publicytnetworkstatus-offline")}))}
u(Ql,J);Ql.prototype.G=function(){var a=B("yt.networkStatusManager.instance.isNetworkAvailable");return a?a.bind(this.i)():!0};
Ql.prototype.T=function(a){var b=B("yt.networkStatusManager.instance.networkStatusHint").bind(this.i);b&&b(a)};
Ql.prototype.V=function(a){var b=this,c;return x(function(d){c=B("yt.networkStatusManager.instance.sendNetworkCheckRequest").bind(b.i);return P("skip_network_check_if_cfr")&&Gl().isEndpointCFR("generate_204")?d.return(new Promise(function(e){var f;b.T((null==(f=window.navigator)?void 0:f.onLine)||!0);e(b.G())})):c?d.return(c(a)):d.return(!0)})};
function Rl(a,b){a.wa?a.j?(De.Z(a.P),a.P=De.M(function(){a.C!==b&&(xe(a,b),a.C=b,a.j=R())},a.wa-(R()-a.j))):(xe(a,b),a.C=b,a.j=R()):xe(a,b)}
;var Sl;function Tl(){al.call(this,{F:{ib:vl,ba:ul,Oa:rl,qb:sl,Ga:tl,set:pl},H:Ul(),handleError:zh,ca:Ah,U:Vl,now:R,bb:Jl,K:Ri(),Fa:"publicytnetworkstatus-online",Ea:"publicytnetworkstatus-offline",qa:!0,pa:.1,va:Vh("potential_esf_error_limit",10),B:P,fa:!($i()&&(P("embeds_web_nwl_disable_nocookie")?"www.youtube-nocookie.com"!==Tb(document.location.toString()):1))});this.l=new $f;P("networkless_immediately_drop_all_requests")&&wl();$k("LogsDatabaseV2")}
u(Tl,al);function Wl(){var a=B("yt.networklessRequestController.instance");a||(a=new Tl,C("yt.networklessRequestController.instance",a),P("networkless_logging")&&Sk().then(function(b){a.u=b;bl(a);a.l.resolve();a.qa&&Math.random()<=a.pa&&a.u&&Al(a.u);P("networkless_immediately_drop_sw_health_store")&&Xl(a)}));
return a}
Tl.prototype.writeThenSend=function(a,b){b||(b={});$i()||(this.i=!1);al.prototype.writeThenSend.call(this,a,b)};
Tl.prototype.sendThenWrite=function(a,b,c){b||(b={});$i()||(this.i=!1);al.prototype.sendThenWrite.call(this,a,b,c)};
Tl.prototype.sendAndWrite=function(a,b){b||(b={});$i()||(this.i=!1);al.prototype.sendAndWrite.call(this,a,b)};
Tl.prototype.awaitInitialization=function(){return this.l.promise};
function Xl(a){var b;x(function(c){if(!a.u)throw b=nj("clearSWHealthLogsDb"),b;return c.return(Bl(a.u).catch(function(d){a.handleError(d)}))})}
...
function Ul(){Sl||(Sl=new Ql({Ta:!0,Ma:!0}));return Sl}
...
e.options.onSuccess=function(k,l){P("use_cfr_monitor")&&Gl().requestComplete(e.url,!0);void 0!==e.id?ul(e.id,d):f=!0;P("vss_network_hint")&&dm().T(!0);g(k,l)};
...
pl(e,d).then(function(k){e.id=k;f&&ul(e.id,d)}).catch(function(k){dm().G()?zh(k):Jl(k)})}else fm(a,b)}
b=void 0===b?{}:b;P("skip_is_supported_killswitch")?Sk().then(function(d){c(d)}):c(Rk())}
function im(){var a=Rk();if(!a)throw nj("throttleSend");Zl||(Zl=De.M(function(){var b;return x(function(c){if(1==c.i)return v(c,rl("NEW",a),2);if(3!=c.i)return b=c.j,b?v(c,gm(b),3):(De.Z(Zl),Zl=0,c.return());Zl&&(Zl=0,im());c.i=0})},100))}
function gm(a){var b,c,d;return x(function(e){switch(e.i){case 1:b=Rk();if(!b)throw c=nj("immediateSend"),c;if(void 0===a.id){e.s(2);break}return v(e,sl(a.id,b),3);case 3:(d=e.j)?a=d:Ah(Error("The request cannot be found in the database."));case 2:var f=a.timestamp;if(!(2592E6<=R()-f)){e.s(4);break}Ah(Error("Networkless Logging: Stored logs request expired age limit"));if(void 0===a.id){e.s(5);break}return v(e,ul(a.id,b),5);case 5:return e.return();case 4:a.skipRetry||(a=jm(a));f=a;var g,h;if(null==
f?0:null==(g=f.options)?0:null==(h=g.postParams)?0:h.requestTimeMs)f.options.postParams.requestTimeMs=Math.round(R());a=f;if(!a){e.s(0);break}if(!a.skipRetry||void 0===a.id){e.s(8);break}return v(e,ul(a.id,b),8);case 8:fm(a.url,a.options,!!a.skipRetry),e.i=0}})}
function jm(a){var b=Rk();if(!b)throw nj("updateRequestHandlers");var c=a.options.onError?a.options.onError:function(){};
a.options.onError=function(e,f){var g,h,k;return x(function(l){switch(l.i){case 1:P("use_cfr_monitor")&&Gl().requestComplete(a.url,!1);g=hl(f);if(!(P("nwl_consider_error_code")&&g||!P("nwl_consider_error_code")&&km()<=Vh("potential_esf_error_limit",10))){l.s(2);break}if(P("skip_checking_network_on_cfr_failure")&&(!P("skip_checking_network_on_cfr_failure")||Gl().isEndpointCFR(a.url))){l.s(3);break}return v(l,dm().V(),3);case 3:if(dm().G()){l.s(2);break}c(e,f);if(!P("nwl_consider_error_code")||void 0===
(null==(h=a)?void 0:h.id)){l.s(6);break}return v(l,tl(a.id,b,!1),6);case 6:return l.return();case 2:if(P("nwl_consider_error_code")&&!g&&km()>Vh("potential_esf_error_limit",10))return l.return();B("ytNetworklessLoggingInitializationOptions")&&bm.potentialEsfErrorCounter++;$l++;if(void 0===(null==(k=a)?void 0:k.id)){l.s(8);break}return 1>a.sendCount?v(l,tl(a.id,b),12):v(l,ul(a.id,b),8);case 12:De.M(function(){dm().G()&&im()},5E3);
case 8:c(e,f),l.i=0}})};
var d=a.options.onSuccess?a.options.onSuccess:function(){};
a.options.onSuccess=function(e,f){var g;return x(function(h){if(1==h.i)return P("use_cfr_monitor")&&Gl().requestComplete(a.url,!0),void 0===(null==(g=a)?void 0:g.id)?h.s(2):v(h,ul(a.id,b),2);P("vss_network_hint")&&dm().T(!0);d(e,f);h.i=0})};
return a}
function dm(){if(P("use_new_nwl"))return Ul();am||(am=new Ql({Ta:!0,Ma:!0}));return am}
...
;var pm=A.ytPubsubPubsubInstance||new L,qm=A.ytPubsubPubsubSubscribedKeys||{},rm=A.ytPubsubPubsubTopicToKeys||{},sm=A.ytPubsubPubsubIsSynchronous||{};L.prototype.subscribe=L.prototype.subscribe;L.prototype.unsubscribeByKey=L.prototype.la;L.prototype.publish=L.prototype.da;L.prototype.clear=L.prototype.clear;C("ytPubsubPubsubInstance",pm);C("ytPubsubPubsubTopicToKeys",rm);C("ytPubsubPubsubIsSynchronous",sm);C("ytPubsubPubsubSubscribedKeys",qm);var tm=Vh("initial_gel_batch_timeout",2E3),um=Math.pow(2,16)-1,vm=void 0;function wm(){this.l=this.i=this.j=0}
...
function Gm(a,b,c,d){d=void 0===d?!1:d;a&&(vm=new a);a=Vh("tvhtml5_logging_max_batch")||Vh("web_logging_max_batch")||100;var e=R(),f=d?ym.l:xm.l;b.length>=a?Im({writeThenSend:!0},P("flush_only_full_queue")?c:void 0,d):10<=e-f&&(Jm(d),d?ym.l=e:xm.l=e)}
...
function Fm(a,b){var c="";if(a.ea)c="visitorOnlyApprovedKey";else if(a.R){if(void 0===b?0:b){b=a.R.token;c=a.R;var d=new lh;c.videoId?d.setVideoId(c.videoId):c.playlistId&&Vc(d,2,mh,c.playlistId);Dm[b]=d}else b=a.R,c={},b.videoId?c.videoId=b.videoId:b.playlistId&&(c.playlistId=b.playlistId),Cm[a.R.token]=c;c=a.R.token}return c}
function Im(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new ag(function(d){c?(window.clearTimeout(ym.j),window.clearTimeout(ym.i),ym.i=0):(window.clearTimeout(xm.j),window.clearTimeout(xm.i),xm.i=0);if(vm&&vm.isReady())if(void 0!==b)if(c){var e=new Map,f=Bm.get(b)||[];e.set(b,f);Nm(e,d,a);Bm.delete(b)}else e=new Map,f=Am.get(b)||[],e.set(b,f),Lm(e,d,a),Am.delete(b);else c?(Nm(Bm,d,a),Bm.clear()):(Lm(Am,d,a),Am.clear());else Jm(c),d()})}
function Jm(a){a=void 0===a?!1:a;if(P("web_gel_timeout_cap")&&(!a&&!xm.i||a&&!ym.i)){var b=Jh(function(){Im({writeThenSend:!0},void 0,a)},6E4);
a?ym.i=b:xm.i=b}window.clearTimeout(a?ym.j:xm.j);b=N("LOGGING_BATCH_TIMEOUT",Vh("web_gel_debounce_ms",1E4));P("shorten_initial_gel_batch_timeout")&&zm&&(b=tm);b=Jh(function(){Im({writeThenSend:!0},void 0,a)},b);
a?ym.j=b:xm.j=b}
...
function Rm(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,Ua:a,ea:b,Pb:!!e,headers:{},postBodyFormat:"",postBody:""}}
...
;function Ym(a,b){var c=void 0===c?{}:c;var d=lm;N("ytLoggingEventsDefaultDisabled",!1)&&lm==lm&&(d=null);a:{c=void 0===c?{}:c;if(P("lr_drop_other_and_business_payloads")){if(nm[a]||mm[a])break a}else if(P("lr_drop_other_payloads")&&nm[a])break a;var e={},f=Math.round(c.timestamp||R());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=om();e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};P("log_sequence_info_on_gel_web")&&c.ja&&(a=e.context,b=c.ja,b={index:Xm(b),groupKey:b},a.sequence=
b,c.lb&&delete Wm[c.ja]);(c.tb?Km:Em)({endpoint:"log_event",payload:e,R:c.R,ea:c.ea},d)}}
;var Zm=[{Da:function(a){return"Cannot read property '"+a.key+"'"},
...
ta:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var an={Y:[],W:[{gb:$m,weight:500}]};function $m(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function bn(){this.W=[];this.Y=[]}
var cn;function dn(){if(!cn){var a=cn=new bn;a.Y.length=0;a.W.length=0;an.Y&&a.Y.push.apply(a.Y,an.Y);an.W&&a.W.push.apply(a.W,an.W)}return cn}
...
function Cn(a){rg.da.apply(rg,arguments)}
;function Dn(a){this.i=a||{};a=[this.i,window.YTConfig||{}];for(var b=0;b<a.length;b++)a[b].host&&(a[b].host=a[b].host.toString().replace("http://","https://"))}
function En(a,b){a=[a.i,window.YTConfig||{}];for(var c=0;c<a.length;c++){var d=a[c][b];if(void 0!==d)return d}return null}
function Fn(a,b,c){Gn||(Gn={},Ih(window,"message",function(d){a:{if(d.origin===En(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Gn[e.id])d.v=!0,d.v&&(D(d.A,d.sendMessage,d),d.A.length=0),d.Ia(e)}e=void 0}return e}));
Gn[c]=b}
var Gn=null;var Hn=window;function In(a,b,c){this.o=this.i=this.j=null;this.l=0;this.v=!1;this.A=[];this.m=null;this.J={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.C=c;this.setup(a,b)}
m=In.prototype;m.setSize=function(a,b){this.i.width=a.toString();this.i.height=b.toString();return this};
m.getIframe=function(){return this.i};
m.Ia=function(a){Jn(this,a.event,a)};
m.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.m.subscribe(a,c);Kn(this,a);return this};
function Ln(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.C===b[0]&&Kn(a,c)}}
m.destroy=function(){this.i&&this.i.id&&(xn[this.i.id]=null);var a=this.m;a&&"function"==typeof a.dispose&&a.dispose();if(this.o){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.o,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);Gn&&(Gn[this.id]=null);this.j=null;a=this.i;for(var c in lb)lb[c][0]==a&&Gh(c);this.o=this.i=null};
m.La=function(){return{}};
function Mn(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.v?a.sendMessage(b):a.A.push(b)}
function Jn(a,b,c){a.m.m||(c={target:a,data:c},a.m.da(b,c),Cn(a.C+"."+b,c))}
function Nn(a,b){var c=document.createElement("iframe");b=b.attributes;for(var d=0,e=b.length;d<e;d++){var f=b[d].value;null!=f&&""!==f&&"null"!==f&&c.setAttribute(b[d].name,f)}c.setAttribute("frameBorder","0");c.setAttribute("allowfullscreen","1");c.setAttribute("allow","accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture");c.setAttribute("title","YouTube "+En(a.j,"title"));(b=En(a.j,"width"))&&c.setAttribute("width",b.toString());(b=En(a.j,"height"))&&c.setAttribute("height",
...
function On(a){Fn(a.j,a,a.id);a.l=Kh(a.Va.bind(a));Ih(a.i,"load",function(){window.clearInterval(a.l);a.l=Kh(a.Va.bind(a))})}
m.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Ub(a.src):"https://www.youtube.com"),this.j=new Dn(b),c||(b=Nn(this,a),this.o=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),xn[this.i.id]=this,window.postMessage){this.m=new L;On(this);b=En(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in zn)zn.hasOwnProperty(e)&&
Ln(this,e)}};
function Kn(a,b){a.J[b]||(a.J[b]=!0,Mn(a,"addEventListener",[b]))}
...
0;X<rn.length&&!(ua=hn(rn[X],"params.context."+X,p,ua),500<=ua);X++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:F,lineNumber:O,fileName:fb,stack:ic,params:p,sampleWeight:1},xj=Number(w.columnNumber);isNaN(xj)||(S.lineNumber=S.lineNumber+":"+xj);if("IGNORED"===w.level)n=0;else a:{for(var yj=dn(),zj=t(yj.Y),lf=zj.next();!lf.done;lf=zj.next()){var Aj=lf.value;if(S.message&&S.message.match(Aj.Qb)){n=Aj.weight;break a}}for(var Bj=t(yj.W),
mf=Bj.next();!mf.done;mf=Bj.next()){var Cj=mf.value;if(Cj.gb(S)){n=Cj.weight;break a}}n=1}S.sampleWeight=n;for(var Dj=t(Zm),nf=Dj.next();!nf.done;nf=Dj.next()){var of=nf.value;if(of.ta[S.name])for(var Ej=t(of.ta[S.name]),pf=Ej.next();!pf.done;pf=Ej.next()){var Fj=pf.value,ud=S.message.match(Fj.regexp);if(ud){S.params["params.error.original"]=ud[0];for(var qf=Fj.groups,Gj={},Ob=0;Ob<qf.length;Ob++)Gj[qf[Ob]]=ud[Ob+1],S.params["params.error."+qf[Ob]]=ud[Ob+1];S.message=of.Da(Gj);break}}}S.params||(S.params=
{});var Hj=dn();S.params["params.errorServiceSignature"]="msg="+Hj.Y.length+"&cb="+Hj.W.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));xb("sample").constructor!==wb&&(S.params["params.fconst"]="true");var qa=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(qa);if(0!==qa.sampleWeight&&!nn.has(qa.message)){if("ERROR"===h){en.da("handleError",qa);if(P("record_app_crashed_web")&&
...
;function Rn(a,b){In.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.N={};this.playerInfo={}}
u(Rn,In);m=Rn.prototype;m.La=function(){var a=En(this.j,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=En(this.j,"embedConfig")){if(Pa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
m.Ia=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.N[c]=a[c]);break;case "infoDelivery":Sn(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.l),this.playerInfo={},this.N={},Tn(this,a.apiInterface),Sn(this,a));break;default:Jn(this,b,a)}};
...
this.N={};Mn(this,c,arguments);return this}:Qn(c)?this[c]=function(){var d=0;
...
return this})},a)}
m.getVideoEmbedCode=function(){var a=En(this.j,"host")+("/embed/"+En(this.j,"videoId")),b=Number(En(this.j,"width")),c=Number(En(this.j,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);Gb.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(Ab,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(Bb,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(Cb,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(Db,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(Eb,"&#39;")),-1!=a.indexOf("\x00")&&
